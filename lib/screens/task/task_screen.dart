...
import 'package:dh_flutter_v2/screens/task/personal_groups.dart';
...
class _TaskScreenState extends State<TaskScreen> {
  ...
  int? orgId;
  List<Group> groups = [];
  List<Group> personalGroups = [];
  List<Group> orgGroups = [];
  List<Task> allTasks = [];
                ...
                return Container(
                  ...
                  child: Column(children: [
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(context,
                            customPageRoute(const PersonalGroupsScreen()));
                      },
                      child: Container(
                        padding: const EdgeInsets.symmetric(
